...
# 18 "main.c"
extern chr_lcd_4bit_t date_time_lcd ;
Std_ReturnType ret = (Std_ReturnType)0x00;
uint8 RTC_Time_Pack[8];
uint8 RTC_Date_Pack[8];
adc_result_t converted_LDR_Value;
adc_result_t converted_GUR_Value;
...
void display_date_time(void){
    Divide_Array_Date_Time(RTC_Date_Pack,RTC_Time_Pack);
